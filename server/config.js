...
export const config = {
    ...
    rateLimits: {
        ...
        /* A reader moving through several pages sends one beacon per page, so
           this bucket is far looser than the one guarding comments. */
        views: { limit: int(process.env.RATE_VIEWS, 120), windowMs: 60_000 },
